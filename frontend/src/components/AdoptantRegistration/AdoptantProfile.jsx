...
const AdoptantRegistration = () => {
  ...
  const fetchProfile = async () => {
    try {
      const response = await api.get('/profile/adopter');
  ...
  // Exibir um "carregando" enquanto formData está null
  if (!formData) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await api.put('/register/adopter/', {
  ...
  const handleEditClick = () => setIsEditing(!isEditing); // Alterna entre visualização e edição
      ...
      {!isEditing ? (
        <div className='profile-view'>
          <div className="profile-section">
            ...
            <p><strong>Nome:</strong> {formData.profile.first_name}</p>
            <p><strong>Sobrenome:</strong> {formData.profile.last_name}</p>
          ...
          <div className="profile-section">
            ...
            <p><strong>Tipo de Residência:</strong> {formData.profile.residence_type}</p>
